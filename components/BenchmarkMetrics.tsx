  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-md">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        ...
        {/* Latency */}
        <div className="rounded-xl border border-slate-800/80 bg-slate-950/60 p-2.5 flex flex-col">
          <span className="text-[10px] text-slate-400 flex items-center gap-1">
            <Timer className="h-3 w-3 text-cyan-400" /> Latency
          </span>
        ...
        <div className="rounded-xl border border-slate-800/80 bg-slate-950/60 p-2.5 flex flex-col">
          <span className="text-[10px] text-slate-400 flex items-center gap-1">
            <Cpu className="h-3 w-3 text-indigo-400" /> Input Shape
          </span>
          <span className="font-mono text-xs font-bold text-slate-100 mt-1 truncate">
            (1, 256, 256, 3)
          </span>
        </div>
        ...
        <div className="rounded-xl border border-slate-800/80 bg-slate-950/60 p-2.5 flex flex-col">
          <span className="text-[10px] text-slate-400 flex items-center gap-1">
            <Sparkles className="h-3 w-3 text-teal-400" /> Engine
          </span>
          <span className="font-mono text-xs font-bold text-slate-100 mt-1 truncate uppercase">
        ...
        <div className="rounded-xl border border-slate-800/80 bg-slate-950/60 p-2.5 flex flex-col">
          <span className="text-[10px] text-slate-400 flex items-center gap-1">
            <Layers className="h-3 w-3 text-emerald-400" /> Memory Guard
          </span>
